...
--- Inheritance is defined as the mechanism of inheriting the properties of the base
        class to the child class. Here we a going to see the types of inheritance in Python.
...
(2) Multiple Inheritance: 
        ...
        multiple inheritances. In multiple inheritances, all the features of the base classes
...
(4) Hierarchical Inheritance: 
        ...
        hierarchical inheritance. In this program, we have a parent (base) class and two 
